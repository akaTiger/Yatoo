...
if __name__ == "__main__":
    ...
    # Label Frame
    fA = Frame(rootWindow)
    fA.pack(fill="both", expand=True, side="top")
    fB = Frame(rootWindow)
    fB.pack(fill="both", expand=True, side="bottom")
    passwdGen1 = LabelFrame(fA, text="Ramdom Password Generator", padx=20, pady=20)
    passwdGen1.pack(fill="both", expand=True, side="left",padx=20,pady=20)
    hashGen1 = LabelFrame(fA, text="Hash Gernerator", padx=20, pady=20)
    hashGen1.pack(fill="both", expand=True, side="left",padx=20,pady=20)
    codeDecode1 = LabelFrame(fA, text="Base Encode/Decode", padx=20, pady=20)
    codeDecode1.pack(fill="both", expand=True, side="left",padx=20,pady=20)
    otherCodeDecode1 = LabelFrame(fB, text="Caser Cipher Encode/Decode", padx=20, pady=20)
    otherCodeDecode1.pack(fill="both", expand=True, side="left",padx=20,pady=20)
    railFenceC1 = LabelFrame(fB, text="Rail Fence N/V Encode/Decode", padx=20, pady=20)
    railFenceC1.pack(fill="both", expand=True, side="left",padx=20,pady=20)
    oldCode1f = LabelFrame(fB, text="Other Encode/Decode", padx=20, pady=20)
    oldCode1f.pack(fill="both", expand=True, side="left",padx=20,pady=20)
    # passwd gen start
    if True:
        # dynamic var init
        ...
        # Inner Frame
        choiceFrame1 = Frame(passwdGen1)
        choiceFrame1.pack(side="top")
        digitChoiceDisplay = Frame(choiceFrame1)
        digitChoiceDisplay.pack(side="left", anchor="n")
        modeChoiceDisplay = Frame(choiceFrame1)
        modeChoiceDisplay.pack(side="left", anchor="n")
    ...
    if True:
        ...
        # inner frame
        hashModeD = Frame(hashGen1)
        hashModeD.pack(side="top")
        hashMode1 = Frame(hashModeD)
        hashMode1.pack(side="left", anchor="n")
        hashMode2 = Frame(hashModeD)
        hashMode2.pack(side="left", anchor="n")
        inputAndRun = Frame(hashGen1)
        inputAndRun.pack(side="bottom")
        # mode lst 1
    ...
    if True:
        ...
        cdMode.set("rc4de")
        # inner frame
        cdF = Frame(codeDecode1)
        cdF.pack(side="top")
        cd1 = Frame(cdF)
        cd1.pack(side="left", anchor="n")
        cd2 = Frame(cdF)
        cd2.pack(side="left", anchor="n")
        usrPrompt = Frame(codeDecode1)
        usrPrompt.pack(side="bottom")
        # cd lst1
    ...
    if True:
        ...
        # frame init
        ocdH = Frame(otherCodeDecode1)
        ocdH.pack(side="top")
        ocd1 = Frame(ocdH)
        ocd1.pack(side="left", anchor="n")
        ocd2 = Frame(ocdH)
        ocd2.pack(side="left", anchor="n")
        ocdEntry = Frame(otherCodeDecode1)
        ocdEntry.pack(side="bottom")
        # ocd1 button init
    ...
    if True:
        ...
        # frame init
        rfcH = Frame(railFenceC1)
        rfcH.pack(side="top")
        rfc1 = Frame(rfcH)
        rfc1.pack(side="left", anchor="n")
        rfc2 = Frame(rfcH)
        rfc2.pack(side="left", anchor="n")
        rfcEntry = Frame(railFenceC1)
        rfcEntry.pack(side="bottom")
        # rfc1
    ...
    if True:
        ...
        # frame init
        odlCodeH = Frame(oldCode1f)
        odlCodeH.pack(side="top")
        oldCode1 = Frame(odlCodeH)
        oldCode1.pack(side="left", anchor="n")
        oldCode2 = Frame(odlCodeH)
        oldCode2.pack(side="left", anchor="n")
        oldCodeEntry = Frame(oldCode1f)
        oldCodeEntry.pack(side="bottom")
        # oldCode1
